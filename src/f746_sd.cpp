...
int SD_F746::read(void *b, bd_addr_t addr, bd_size_t size)
{
...
int SD_F746::program(const void *b, bd_addr_t addr, bd_size_t size)
{
...
int SD_F746::erase(bd_addr_t addr, bd_size_t size)
{
...
bd_size_t SD_F746::get_read_size() const
{
    return _read_size;
}

bd_size_t SD_F746::get_program_size() const
{
    return _program_size;
}

bd_size_t SD_F746::get_erase_size() const
{
    return _erase_size;
}

bd_size_t SD_F746::size() const
{
